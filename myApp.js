...
/*
GLITCH LINK: https://glitch.com/edit/#!/spiky-point
*/
...
var createAndSavePerson = function(done) {
  const person = new Person({name: "Brad", age: 30, favoriteFoods: ["apples","pizza"]});
...
var removeManyPeople = function(done) {
  ...
  Person.remove({name: nameToRemove}, (err, doc) => {
    if (err) done(err);
    else done(null, doc); // unsure what document/s this returns
  });
};
